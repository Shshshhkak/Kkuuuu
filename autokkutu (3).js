...
(function () {
  ...
  function buildPanel() {
    ...
    head.innerHTML = '<div class="ak-title">단어 도우미 <small>v1.3</small></div>';
    ...
    warn.innerHTML = "처음 1회는 <b>방에 들어가기 전 (로비)</b> 에서 사전을 로드하세요. " +
      "방 안에서 처음 로드하면 ws 가 끊길 수 있습니다 (5MB · 43만 단어).<br>" +
      "캐시되면 이후엔 어디서든 즉시 로드됩니다.";
  ...
  updateStatus();
  log("v1.3 로드. 처음 1회는 로비에서 '사전 로드' 권장.");
})();
